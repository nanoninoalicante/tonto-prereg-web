...
const primaryUrl = "https://www.gettonto.com/start";
const metaTagImage = "https://s.gettonto.com/secureYourHandleAtTonto.png";
export function useMetaTags() {
    return { description, title, primaryUrl, metaTagImage };
}
